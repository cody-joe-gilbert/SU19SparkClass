# Map Profiling and cleaning
This folder contains the tools and method to download US Census county and state mapping data that is used to geographically partition HMDA loan data for analysis.

## Included files

### Scripts
* `runscript.sh` Script used to run Scala code on Dumbo cluster
...
* [County Data]( https://catalog.data.gov/dataset/tiger-line-shapefile-2017-nation-u-s-current-county-and-equivalent-national-shapefile )
