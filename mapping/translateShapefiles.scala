...
// Read in the state-wide shapefile and repackage as a .csv DF
val stateShapefile="/users/cjg507/sparkproject/geometries/states"
...
stateDFNoSchema.coalesce(1).write.mode("overwrite").format("csv").save(shapefileInputLocation + "/stateGeom.csv")

// Read in the county-wide shapefile and repackage as a .csv DF
val countyShapefile="/users/cjg507/sparkproject/geometries/county"
...
countyDFNoSchema.coalesce(1).write.mode("overwrite").format("csv").save(shapefileInputLocation + "/countyGeom.csv")
